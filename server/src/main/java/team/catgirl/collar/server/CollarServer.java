...
public class CollarServer {
    ...
    public CollarServer(Services services) {
        ...
        protocolHandlers.add(new LocationProtocolHandler(services.playerLocations, services.waypoints, services.maps, services.sessions, services.identityStore.getIdentity()));
