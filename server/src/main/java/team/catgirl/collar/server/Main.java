...
public class Main {
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException {
        ...
        ObjectMapper json = Utils.createJsonMapper();
        ObjectMapper protobuf = Utils.createProtobufMapper();
        ...
        webSocket("/api/1/listen", new CollarServer(protobuf, sessions, serverIdentityStore, profiles, urlProvider, minecraftSessionVerifier, protocolHandlers));
